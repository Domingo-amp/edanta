...
onmouseout="this.style.opacity=1;this.filters.alpha.opacity=100""/></a></td>
  ...
  <tr>
    <td><a href="no.php"><img src="img/galeria.png" width="165" height="165" style="opacity:0.6;filter:alpha(opacity=60)"/></a></td>
    <td><a href="#"><img src="img/tutorial.png" width="165" height="165" style="opacity:0.6;filter:alpha(opacity=60)"/></a></td>
